...
"Il n'y a aucun marin visible." CR>)
		(<VERB? HELLO>
		 ...
		 %<COND (<==? ,ZORK-NUMBER 3>
			 '<COND (<NOT <FSET? ,VIKING-SHIP ,INVISIBLE>>
		                 <TELL
"Le marin lève les yeux et manoeuvre son bateau vers la rive. Il s'écrie : « Voilà trois âges que j'attends que quelqu'un prononce ces mots et me délivre de cet océan sans fin. Veuillez accepter ce présent ; il pourrait vous être utile ! » Il lance un objet qui tombe près de vous dans le sable, puis repart vers l'ouest en chantant une chanson de marin entraînante, quoique passablement grossière." CR>
